<template>
  ...
  <section class="src-components-formulario-alta container">
    <div class='card mt-5'>
      <div class="card-header">
        <h3 class="card-title">Formulario de alta de producto</h3>
      </div>
      <div class="card-body">
        ...
        <vue-form :state="formState" @submit.prevent="enviar">
          ...
          <validate tag="div">
            ...
            <input type="text" id="codigo" name="codigo" class="form-control" autocomplete="off"
              v-model.trim="formData.codigo" required :minlength="codigoMinLength" no-espacios />
          ...
          <validate tag="div">
            ...
            <input type="text" id="nombre" name="nombre" class="form-control" autocomplete="off"
              v-model.trim="formData.nombre" required />
          ...
          <validate tag="div">
            ...
            <input type="number" id="precio" name="precio" class="form-control" autocomplete="off"
              v-model.number="formData.precio" required :min="cantidadMinPrecio" />
          ...
          <validate tag="div">
            ...
            <input type="number" id="cantidad" name="cantidad" class="form-control" autocomplete="off"
              v-model.trim="formData.cantidad" required :min="cantidadMin" />
          ...
          <validate tag="div">
            ...
            <input type="text" id="sucursal" name="sucursal" class="form-control" autocomplete="off"
              v-model.trim="formData.sucursal" required />
          ...
          <validate tag="div">
            ...
            <input type="text" id="categoria" name="categoria" class="form-control" autocomplete="off"
              v-model.trim="formData.categoria" required />
